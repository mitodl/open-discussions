...
worker: bin/start-pgbouncer newrelic-admin run-program celery -A open_discussions.celery:app worker -Q spam,default --concurrency=2 -B -l $OPEN_DISCUSSIONS_LOG_LEVEL
