...
import { Profile, ProfilePayload } from "../flow/discussionTypes";

const updateProfileHandler = (payload: Profile, data: Map<string, Profile>): Map<string, Profile> => {
...
export const profilesEndpoint = {
  ...
  patchFunc: (username: string, payload: ProfilePayload) => api.updateProfile(username, payload),
