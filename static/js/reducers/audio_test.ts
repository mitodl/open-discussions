...
import { INITIAL_AUDIO_STATE, setAudioPlayerState, setCurrentlyPlayingAudio, stopAudioPlayer } from "./audio";
...
describe("audio reducer", () => {
  ...
  it("should let you set the currently playing audio", async () => {
    ...
    dispatchThen(setCurrentlyPlayingAudio(exampleAudio), [setCurrentlyPlayingAudio.type]);
