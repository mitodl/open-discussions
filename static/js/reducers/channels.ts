...
const updateChannelHandler = (payload: Channel, data: Map<string, Channel>): Map<string, Channel> => produce(data, draftState => {
...
export const channelsEndpoint = {
  ...
  extraActions: {
    [SET_CHANNEL_DATA]: (state: Object, action: Action<any>) => produce(state, draftState => {
