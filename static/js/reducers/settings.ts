...
export const FRONTPAGE_FREQUENCY_CHOICES = [{ value: FREQUENCY_NEVER, label: "Never" }, { value: FREQUENCY_DAILY, label: "Daily" }, { value: FREQUENCY_WEEKLY, label: "Weekly" }];

export type FrontpageFrequency = typeof FREQUENCY_NEVER | typeof FREQUENCY_DAILY | typeof FREQUENCY_WEEKLY;

export type CommentFrequency = typeof FREQUENCY_NEVER | typeof FREQUENCY_IMMEDIATE;

export const settingsEndpoint = {
  name: "settings",
  verbs: [GET, PATCH],
  getFunc: (token: string | null | undefined) => api.getSettings(token),
  patchFunc: async (object: Object, token: string | null | undefined) => {
