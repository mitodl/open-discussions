...
import { SET_FOCUSED_COMMENT, CLEAR_FOCUSED_COMMENT, setFocusedComment, clearFocusedComment, SET_FOCUSED_POST, CLEAR_FOCUSED_POST, setFocusedPost, clearFocusedPost } from "../actions/focus";
...
describe("focus reducer", () => {
  ...
  it("should let you set and clear the focused comment", async () => {
    let state = await dispatchThen(setFocusedComment(comment), [SET_FOCUSED_COMMENT]);
