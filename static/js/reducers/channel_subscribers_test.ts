...
describe("channelSubscribers reducers", () => {
  ...
  beforeEach(() => {
    ...
    dispatchThen = helper.store.createDispatchThen(state => state.channelSubscribers);
  ...
  it("should add a new subscriber", async () => {
    ...
    await dispatchThen(actions.channelSubscribers.post(channelName, newSubscriber.subscriber_name), [actions.channelSubscribers.post.requestType, actions.channelSubscribers.post.successType]);
  ...
  it("should remove a subscriber", async () => {
    ...
    await dispatchThen(actions.channelSubscribers.delete(channelName, newSubscriber.subscriber_name), [actions.channelSubscribers.delete.requestType, actions.channelSubscribers.delete.successType]);
