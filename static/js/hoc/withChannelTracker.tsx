...
const shouldLoadData = R.complement(R.allPass([// if channel name doesn't match
R.eqBy(R.path(["channel", "name"])), // if URL path doesn't match
R.eqBy(R.path(["location", "search"]))]));

export const withChannelTracker = (WrappedComponent: Class<React.Component<any, any>>) => {
  class WithChannelTracker extends React.Component<any, any> {
