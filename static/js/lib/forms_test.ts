...
import { configureForm, getAuthResponseFieldErrors, objectToFormData } from "./forms";
import { FORM_BEGIN_EDIT, FORM_END_EDIT, FORM_UPDATE, FORM_VALIDATE } from "../actions/forms";
...
describe("forms lib", () => {
  ...
  describe("getAuthResponseFieldErrors", () => {
    ...
    ;[[{ errors: [errorText] }, { [field]: errorText }, "response object with errors"], [{}, undefined, "response object without errors"], [undefined, undefined, "undefined response object"]].forEach(([responseObj, expReturnValue, desc]) => {
