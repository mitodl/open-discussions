...
import { createPost, getPost, deletePost, editPost, updateRemoved } from "./posts";
...
describe("Post API", () => {
  ...
  ;[["text", "text"], ["title", "title"], ["stickied", true], ["ignore_reports", true], ["subscribed", true]].forEach(([fieldName, val]) => {
