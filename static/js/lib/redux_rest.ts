...
export const endpoints = [postsEndpoint, subscribedChannelsEndpoint, channelsEndpoint, channelContributorsEndpoint, channelModeratorsEndpoint, channelSubscribersEndpoint, channelInvitationsEndpoint, postsForChannelEndpoint, frontPageEndpoint, commentsEndpoint, moreCommentsEndpoint, postUpvotesEndpoint, postRemovedEndpoint, reportsEndpoint, settingsEndpoint, accountSettingsEndpoint, embedlyEndpoint, profilesEndpoint, userWebsitesEndpoint, userContributionsEndpoint, authEndpoint, passwordResetEndpoint, passwordChangeEndpoint, profileImageEndpoint, channelAvatarEndpoint, channelBannerEndpoint, searchEndpoint, relatedPostsEndpoint, widgetsEndpoint, livestreamEndpoint];
 ...
 */
export function createActionHelper(dispatch: Dispatch<any>, actionCreator: Function): (...args: any) => void {
