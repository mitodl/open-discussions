...
import { LearningResource } from "../flow/discussionTypes";
...
export const configureShallowRenderer = (Component: Class<React.Component<any, any>> | Function, defaultProps: Object) => (extraProps: Object = {}) => shallow(<Component {...defaultProps} {...extraProps} />);
...
export const mockCourseAPIMethods = (helper: Object, upcomingCourses: Array<LearningResource> | null | undefined = null, newCourses: Array<LearningResource> | null | undefined = null) => {
  helper.handleRequestStub.withArgs(upcomingCoursesURL).returns(queryListResponse(upcomingCourses || R.times(makeCourse, 10)));
  helper.handleRequestStub.withArgs(newCoursesURL).returns(queryListResponse(newCourses || R.times(makeCourse, 10)));
};
...
export const changeFormikInput = (wrapper: Object, name: string, value: any) => {
...
export const mockHTMLElHeight = (scrollHeight: number, offsetHeight: number) => {
  // $FlowFixMe
