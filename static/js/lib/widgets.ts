...
import { WIDGET_TYPE_MARKDOWN, WIDGET_TYPE_PEOPLE, WIDGET_TYPE_RSS, WIDGET_TYPE_URL } from "./constants";
import { incrementer } from "./util";

import { WidgetInstance } from "../flow/widgetTypes";
...
export const getWidgetKey = (widgetInstance: WidgetInstance): string => String(widgetInstance.id || widgetInstance.newId);