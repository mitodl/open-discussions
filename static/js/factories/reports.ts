...
import { Post, PostReportRecord, CommentReportRecord } from "../flow/discussionTypes";
...
export const makePostReport = (post: Post | null | undefined = undefined): PostReportRecord => {
  post = post || makePost();
  post.num_reports = 2;
...
export const makeReportRecord = () => casual.boolean ? makePostReport() : makeCommentReport(makePost());