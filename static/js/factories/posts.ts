...
export const makeChannelPostList = (channelName: string = casual.word) => R.range(0, 20).map(() => makePost(casual.boolean, channelName));

export const makeFrontPageList = () => R.range(0, 30).map(() => makePost(casual.boolean));
