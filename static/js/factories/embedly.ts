...
export const makeArticle = () => ({
  ...
  thumbnail_url: "https://static01.nyt.com/images/2018/04/30/us/30globaltrade-1/30globaltrade-1-facebookJumbo.jpg",
...
export const makeTweet = () => ({
  ...
  thumbnail_url: "https://pbs.twimg.com/profile_images/839863609345794048/mkpdB9Tf_400x400.jpg",
  type: "rich",
...
export const makeYoutubeVideo = () => ({
  ...
  description: "This is one of our best dog compilations! Chihuahuas are sooo funny! The hardest TRY NOT TO LAUGH challenge in the World! Just look how all these chihuahuas behave, play, fail, make funny sounds, react to different things,... So ridiculous, funny and cute! What is your favorite clip?",
  title: "Are CHIHUAHUAS the FUNNIEST DOGS? - Funny CHIHUAHUA DOG videos that will make you LAUGH LIKE HELL",
