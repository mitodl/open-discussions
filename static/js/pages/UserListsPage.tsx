...
import { myUserListsSelector, userListsRequest } from "../lib/queries/user_lists";
...
const favoritesPseudoListSelector = createSelector(favoritesListSelector, favorites => ({
  title: "My Favorites",
...
export default function UserListsPage() {
  ...
  return <BannerPageWrapper>
      ...
      {showCreateListDialog ? <UserListFormDialog hide={() => setShowCreateListDialog(false)} /> : null}
      <Grid className="main-content one-column narrow user-list-page">
        ...
        {isFinishedFavorites ? <Cell width={12}>
            <UserListCard userList={favoritesUserList} hideUserListOptions />
          </Cell> : null}
        {isFinished ? userLists.map((list, i) => <Cell width={12} key={i}>
