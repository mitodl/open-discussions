...
import ConnectedLoginProviderRequiredPage, { LoginProviderRequiredPage } from "./LoginProviderRequiredPage";
...
describe("LoginProviderRequiredPage", () => {
  ...
  beforeEach(() => {
    ...
    renderPage = helper.configureHOCRenderer(ConnectedLoginProviderRequiredPage, LoginProviderRequiredPage, DEFAULT_STATE, {
      history: {
  ...
  ;[["micromasters", 'a[href="/login/micromasters/"]'], ["saml", "TouchstoneLoginButton"]].forEach(([provider, expectedElementSel]) => {
