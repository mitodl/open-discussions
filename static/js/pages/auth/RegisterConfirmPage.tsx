...
const confirmationCodeFromLocation = R.compose(R.propOr(null, "verification_code"), qs.parse, R.propOr("", "search"));

const partialTokenFromLocation = R.compose(R.propOr(null, "partial_token"), qs.parse, R.propOr("", "search"));
...
export class RegisterConfirmPage extends React.Component<Props> {
  ...
  render() {
    ...
    return <div className="auth-page register-confirm-page">
...
const confirmCode = (partialToken: string, code: string) => actions.auth.registerConfirm(FLOW_REGISTER, partialToken, code);
