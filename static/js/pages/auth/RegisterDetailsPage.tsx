...
import { getAuthPartialTokenSelector, isProcessing, getFormErrorSelector, FLOW_REGISTER } from "../../reducers/auth";

import { Match } from "react-router";
import { DetailsForm } from "../../flow/authTypes";
...
export const RegisterDetailsPage = ({
  ...
  formError,
  match
}: RegisterDetailsPageProps) => <div className="auth-page register-details-page">
...
const onSubmit = (partialToken: string, form: DetailsForm) => actions.auth.registerDetails(FLOW_REGISTER, partialToken, form.name, form.password);
...
const {
  getForm,
  actionCreators
} = configureForm(FORM_KEY, newDetailsForm);
...
export default R.compose(connect(mapStateToProps, {
  onSubmit,
  ...actionCreators
}, mergeProps), withForm(AuthDetailsForm))(RegisterDetailsPage);