...
const renderExternalProviderLink = (provider: string) => {
  switch (provider) {
    case "micromasters":
      return <a href={`/login/${provider}/`} className="link-button">
          MicroMasters
      </a>;
    case "saml":
...
export const LoginProviderRequiredPage = ({
  ...
  return <div className="auth-page login-provider-page">
      <div className="main-content">
...
export default connect<Props, OwnProps, _, _, _, _>(mapStateToProps)(LoginProviderRequiredPage);