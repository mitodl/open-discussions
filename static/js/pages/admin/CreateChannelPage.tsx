...
class CreateChannelPage extends React.Component<Props> {
  ...
  componentDidMount() {
    ...
    dispatch(actions.forms.formBeginEdit(R.merge(CREATE_CHANNEL_PAYLOAD, {
  ...
  onUpdate = (e: Object) => {
    ...
    dispatch(actions.forms.formUpdate(R.merge(CREATE_CHANNEL_PAYLOAD, {
      value: {
    ...
    return <div className="content">
        ...
        <div className="main-content">
          <Card title="Create a Channel">
            <CreateChannelForm onSubmit={this.onSubmit} onUpdate={this.onUpdate} form={channelForm.value} />
          </Card>
        </div>
      </div>;
  }
...
export default connect<Props, OwnProps, _, _, _, _>(mapStateToProps)(CreateChannelPage);