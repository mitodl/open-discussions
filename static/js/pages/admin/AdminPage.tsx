...
export default class AdminPage extends React.Component<Props> {
  ...
  render() {
    ...
    return <React.Fragment>
        ...
        <Route path={`${match.url}/c/edit/:channelName/basic`} component={EditChannelBasicPage} />
        <Route path={`${match.url}/c/edit/:channelName/appearance`} component={EditChannelAppearancePage} />
        <Route path={`${match.url}/c/edit/:channelName/members/moderators`} component={EditChannelModeratorsPage} />
        <Route path={`${match.url}/c/edit/:channelName/members/contributors`} component={EditChannelContributorsPage} />
        <Route path={`${match.url}/c/edit/:channelName/moderation`} component={ChannelModerationPage} />
      </React.Fragment>;
  }
}