...
const HomepageSidebar = () => <React.Fragment>
    <LiveStream />
    {SETTINGS.course_ui_enabled ? <NewCoursesWidget /> : null}
  </React.Fragment>;

export default R.compose(connect(mapStateToProps, mapDispatchToProps), withPostModeration, withSidebar(HomepageSidebar, "home-page"), withPostList, withPostLoading)(HomePage);