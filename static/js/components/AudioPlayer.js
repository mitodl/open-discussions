          ...
          <div className="header-main">
            <div className="player-container player">
              <div className="player-wrap">
                <div
                  className="inner-player simplecast-player"
                    ...
                    <div className="main-wrap dark size-mini">
                      <div className="controls size-mini">
                        <div className="player-controls">
                          <button
                            aria-label="Play"
                            className="amplitude-play-pause play-pause dark size-mini"
                          >
                            <svg
                              viewBox="0 0 44 44"
                              ...
                              className=""
                            >
                              <path d="M22 44C9.85 44 0 34.15 0 22S9.85 0 22 0s22 9.85 22 22-9.85 22-22 22zm-5.333-31.333v18.666L31.333 22l-14.666-9.333z">
                                {" "}
                              </path>
                            </svg>
                          </button>
                          <div className="scrubber-timer">
                            ...
                            <div className="controls-share-subscribe">
                              ...
                              <button className="controls-subscribe dark size-mini">
                                <svg
                                  ...
                                  className=""
                                >
                                  <path d="M0 0h14v1.75H0V0zm0 3.5h8.75v1.75H0V3.5z" />
                                </svg>
                            ...
                            <div className="left">
                              <button
                                aria-label="Speed Rate 1x"
                                className="controls-speed dark size-mini"
                              >
                                1x
                              </button>
                            </div>
                            <div className="middle">
                              <button
                                aria-label="15 Seconds Backward"
                                className="controls-rewind dark"
                              >
                                <svg
                                  width="19"
                                  height="20"
                                  ...
                                  className=""
                                >
                                  <path d="M5.067 4H14a5 5 0 015 5v3a5 5 0 01-5 5h-1.166v-2H14a3 3 0 003-3V9a3 3 0 00-3-3H5.067v4L0 5l5.067-5v4z" />
                                  <text
                              ...
                              <button
                                aria-label="Play"
                                className="play-pause dark size-mini"
                              >
                                <svg
                                  viewBox="0 0 44 44"
                                  xmlns="http://www.w3.org/2000/svg"
                              ...
                              <button
                                aria-label="15 Seconds Forward"
                                className="controls-forward dark"
                              >
                                <svg
                                  width="19"
                                  height="20"
                            ...
                            <div className="right">
                              ...
                              <div aria-hidden="true" className="artwork">
                                <div
                                  className="ratio ratio-1-1 dark"
                                  style={{
                                    backgroundImage:
                                      "url('https://cdn.simplecast.com/images/fad9997e-4c46-4e62-8a3f-4a4c561b53a6/a2b3587e-9be1-4ba2-b5a3-a213a436a1cc/chalk-radio-album-art-v2.jpg')"
                                  }}
                                />
                              </div>
                            </div>
            ...
            <div className="desktop-player-controls">
              <div className="player-controls">
                <button className="player-control speed-control">1x</button>
            ...
            <div className="desktop-player-title">
              <div className="player-titles">
                <h3
                  className="title podcast-title"
                  data-amplitude-song-info="album"
                />
                <h3
                  className="title episode-title"
            ...
            <div className="logo">
              <svg
                viewBox="0 0 25 25"
                xmlns="http://www.w3.org/2000/svg"
                className="icon-logo sc-logo"
              >
                <path d="M24.845 24.845H0V0l12.422 12.423zM21.382 17.518L7.327 3.463l2.021-2.02 14.055 14.054zM21.382 9.612l-6.148-6.148 2.02-2.021 6.15 6.149z" />
              </svg>
            </div>
            <svg
              viewBox="0 0 20 20"
            ...
            >
              <g fill="none" fillRule="evenodd">
                <path
                  d="M0 20h20V0H0v20zm1.333-1.334h17.334V1.333H1.333v17.333z"
                  className="sc-logo-border"
                />
                <path d="M4 4v12h12zM15.057 12.485L7.515 4.942 8.457 4 16 11.542zM15.057 8.714l-3.771-3.772.943-.942 3.77 3.77z" />
              </g>
            </svg>
          </div>
        </div>
