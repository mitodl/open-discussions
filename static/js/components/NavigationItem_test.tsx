...
describe("NavigationItem", () => {
  ...
  const renderNavigationItem = (expanded = true) => mount(<NavigationExpansion.Provider value={expanded}>
        <NavigationItem badge={badge} whenExpanded={whenExpanded} />
      </NavigationExpansion.Provider>) //
  ;[true, false].forEach(expanded => {
    it(`should render badge and ${shouldIf(expanded)} render whenExpended when expanded == ${String(expanded)}`, () => {
