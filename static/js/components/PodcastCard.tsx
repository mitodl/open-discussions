...
export default function PodcastCard(props: Props) {
  ...
  return <Card className="podcast-card borderless">
      <div id="podcast-card-inner-container" tabIndex="0" onKeyPress={e => {
      if (e.key === "Enter") {
        e.preventDefault();
        e.stopPropagation();
        openPodcastDrawer(e);
        ...
        <div className="cover-img">
          <img src={embedlyThumbnail(SETTINGS.embedlyKey, podcast.image_src || defaultResourceImageURL(), PODCAST_IMG_HEIGHT, CAROUSEL_IMG_WIDTH)} height={PODCAST_IMG_HEIGHT} alt={`cover image for ${podcast.title}`} />
        </div>
