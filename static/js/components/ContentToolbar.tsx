...
export default class ContentToolbar extends React.Component<Props> {
  ...
  render() {
    ...
    return <div className="navbar course-toolbar">
          ...
          <div className="mdc-toolbar__row">
            ...
            <section className="mdc-toolbar__section mdc-toolbar__section--align-end user-menu-section">
              <ResponsiveWrapper onlyOn={[TABLET, DESKTOP]}>
                {userIsAnonymous() || !SETTINGS.course_ui_enabled ? <div /> : <Link className="user-list-link" to={userListIndexURL}>
                    <i className="material-icons">bookmark</i>
                    My Lists
                  </Link>}
              </ResponsiveWrapper>
              <UserMenu toggleShowUserMenu={toggleShowUserMenu} showUserMenu={showUserMenu} profile={profile} />
            </section>
          </div>
        </header>
      </div>;
