...
import ManageWidgetHeader, { ManageWidgetHeader as InnerManageWidgetHeader } from "./ManageWidgetHeader";
...
describe("ManageWidgetHeader", () => {
  let helper, render, initialState, initialProps, listResponse, updatedWidgetList, channel;
  ...
  beforeEach(() => {
    ...
    render = helper.configureHOCRenderer(ManageWidgetHeader, InnerManageWidgetHeader, initialState, initialProps);
  });
