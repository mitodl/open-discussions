...
const SortableWidgetInstance: StatelessFunctionalComponent<Props> = SortableElement(({
  ...
  return <Card className="widget">
        <div className="title-row">
          <span className="title">{widgetInstance.title}</span>
          {editing ? <span className="toggle-collapse material-icons" onClick={toggleExpanded}>
        ...
        {editing ? <React.Fragment>
            ...
            <div className="edit-buttons">
              <i className="material-icons edit widget-button" onClick={() => startEditInstance(widgetInstance)}>
                edit
              </i>
              <i className="material-icons delete widget-button" onClick={() => deleteInstance(widgetInstance)}>
                delete
              </i>
              <DragHandle />
            </div>
