...
import { WidgetForm, WidgetInstance as WidgetInstanceType, WidgetListResponse } from "../../flow/widgetTypes";
...
const mapDispatchToProps = (dispatch: Dispatch<any>, ownProps) => bindActionCreators({
  ...
  patchWidgetInstances: (payload: Object) => actions.widgets.patch(ownProps.channel.widget_list_id, payload)
}, dispatch);

export default R.compose(connect(mapStateToProps, mapDispatchToProps))(ManageWidgetHeader);