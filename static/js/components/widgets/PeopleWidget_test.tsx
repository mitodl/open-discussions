...
describe("PeopleWidget", () => {
  it("renders a PeopleList", () => {
    ...
    assert.deepEqual(wrapper.find(PeopleList).prop("profiles"), widgetInstance.json.people);
    assert.deepEqual(wrapper.find(PeopleList).prop("showAllMembersLink"), widgetInstance.json.show_all_members_link);
