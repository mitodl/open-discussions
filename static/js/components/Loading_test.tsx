...
import { withLoading, withSpinnerLoading, withPostLoading, PodcastLoading, PodcastEpisodeLoading } from "./Loading";
...
describe("Loading component", () => {
  ...
  ;[["notFound", NotFound], ["notAuthorized", NotAuthorized]].forEach(([errorPropName, expectedComponent]) => {
