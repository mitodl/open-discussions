...
import { SEARCH_GRID_UI, SEARCH_LIST_UI, SEARCH_UI_GRID_WIDTHS } from "../lib/search";
...
export const Loading = (props: SpinnerProps) => <div className={`loading ${props.className ? props.className : ""}`}>
...
const AnimatedEmptyCard = () => <div className="post-content-loader">
    <Card className="compact-post-summary">
      <ContentLoader speed={contentLoaderSpeed} style={{ width: "100%", height: "137px" }} width={1000} height={137} preserveAspectRatio="none">
        ...
        <rect x="66%" y="0" rx="5" ry="5" width="34%" height={EMBEDLY_THUMB_HEIGHT} />
      </ContentLoader>
    </Card>
  </div>;

const AnimatedEmptyLRPortrait = () => <Card className="borderless lr-portrait-loader">
    <ContentLoader speed={contentLoaderSpeed} style={{ width: "100%", height: "354px" }} width={1000} height={354} preserveAspectRatio="none">
...
export const PostLoading = () => <div className="card-list-loader">
    <div className="post-list-title">
      <ContentLoader speed={contentLoaderSpeed} style={{ width: "100%", height: "24px" }} width={1000} height={24} preserveAspectRatio="none">
...
export const PodcastEpisodeLoading = () => R.times(i => <Card key={i}>
        <ContentLoader speed={contentLoaderSpeed} style={{ width: "100%", height: "74px" }} width={1000} height={74} preserveAspectRatio="none">
...
export const PodcastLoading = () => <Grid>
    {R.times(i => <Cell width={4} key={i}>
          <Card className="borderless">
            <ContentLoader speed={contentLoaderSpeed} style={{ width: "100%", height: "280px" }} width={1000} height={280} preserveAspectRatio="none">
...
export const CourseSearchLoading = ({
  layout
}: CSLProps) => <Grid className="card-list-loader">
    {R.times(i => <Cell width={layout === SEARCH_GRID_UI ? 4 : 12} key={i}>
          {layout === SEARCH_LIST_UI ? <AnimatedEmptyCard /> : <AnimatedEmptyLRPortrait />}
        </Cell>, 10)}
  </Grid>;
...
export const CarouselLoading = () => {
  ...
  return <div className="course-carousel-loader">
      <ContentLoader speed={contentLoaderSpeed} style={{ width: "100%", height: "30px" }} width={1000} height={30} preserveAspectRatio="none">
...
export const SearchLoading = () => <Grid className="main-content two-column search-page">
...
export const renderDeferredLoading = ({
  ...
  LoadingComponent: Class<React.Component<any, any>> | Function;
  render: Function;
}) => {
  if (notFound) {
    return <NotFound />;
...
export const withLoading = R.curry((LoadingComponent: Class<React.Component<any, any>> | Function, LoadedComponent: Class<React.Component<any, any>>) => {
