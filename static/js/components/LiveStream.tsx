...
type StateProps = {
  liveEvent: LiveStreamEvent | null | undefined;
};
  ...
  render() {
    ...
    if (liveEvent && SETTINGS.livestream_ui_enabled) {
      ...
      return <Card className="widget">
          ...
          <iframe src={livestreamEventURL(ownerAccountId, id)} frameBorder="0" scrolling="no" allowFullScreen />
        </Card>;
    } else {
      return null;
    }
...
export default connect<Props, {}, _, DispatchProps, _, _>(mapStateToProps, mapDispatchToProps)(LiveStream);