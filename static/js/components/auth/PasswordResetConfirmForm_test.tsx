...
describe("PasswordResetConfirmForm component", () => {
  ...
  const getConfirmPasswordInput = wrapper => wrapper.find("input[name='re_new_password']");

  const mountForm = (props = {}) => mount(<PasswordResetConfirmForm onSubmit={onSubmitStub} onUpdate={onUpdateStub} form={form} validation={{}} processing={false} tokenApiError={undefined} {...props} />);
