...
describe("Dialog", () => {
  let sandbox, hideDialog, onCancel, onAccept, submitText, cancelText, title, id, className, open;
  ...
  const render = (props = {}) => shallow(<Dialog open={open} hideDialog={hideDialog} // $FlowFixMe
  onCancel={onCancel} onAccept={onAccept} title={title} // $FlowFixMe
  submitText={submitText} // $FlowFixMe
  cancelText={cancelText} id={id} className={className} {...props}>
        Some Text Here
      </Dialog>);
