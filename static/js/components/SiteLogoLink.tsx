...
export const SocialSiteLogoLink = ({
  site,
  url
}: SocialSiteLogoProps) => <a href={url} target="_blank" rel="noopener noreferrer">
...
export const SiteLogoLink = ({
  url
}: SiteLogoProps) => <a href={url} target="_blank" rel="noopener noreferrer">
