...
describe("LocationPicker", () => {
  ...
  const renderLocationPicker = (props = {}) => mount(<LocationPicker onChange={onChangeStub} onClear={onClearStub} initialLocation={initialLocation} placeholder={placeholder} {...props} />);
  ...
  it("input onChange event should call onChange prop function via updateJSON", () => {
    const wrapper = renderLocationPicker();
    wrapper.find("input").simulate("change", { target: { name: "location", value: "Paris" } });
