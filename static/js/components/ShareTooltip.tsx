  ...
  render() {
    ...
    return <div className="tooltip">
        ...
        <div className="bottom-row">
          {hideSocialButtons ? null : <div className="tooltip-buttons">
...
const ConnectedShareTooltipHelper = connect(R.always({}), // mapStateToProps is not needed - just return an object
{ setSnackbarMessage })(ShareTooltipHelper);
...
export default function ShareTooltip({
  ...
  return <Tooltip placement={placement || "top"} trigger={["click"]} overlay={() => <ConnectedShareTooltipHelper {...props} />}>
      {children}
    </Tooltip>;
}