...
import { CHANNEL_TYPE_PUBLIC, CHANNEL_TYPE_PRIVATE, CHANNEL_TYPE_RESTRICTED, LINK_TYPE_TEXT, editChannelForm } from "../../lib/channels";
import { makeChannel } from "../../factories/channels";

import { ChannelForm } from "../../flow/discussionTypes";

describe("EditChannelBasicForm", () => {
  const renderForm = (form: ChannelForm, {
    onSubmit,
    onUpdate
  } = { onSubmit: () => {}, onUpdate: () => {} }) => shallow(<EditChannelBasicForm form={form} onSubmit={onSubmit} onUpdate={onUpdate} validation={{}} />);
  let sandbox, form;
  ...
  it("should render a blank form", () => {
    ...
    const [publicOption, restrictedOption, privateOption] = wrapper.find('[name="channel_type"]');
  ...
  describe("callbacks", () => {
    ...
    ;[["channel_type", CHANNEL_TYPE_PUBLIC], ["allowed_post_types", LINK_TYPE_TEXT]].forEach(([name, value]) => {
      describe("onUpdate", () => {
