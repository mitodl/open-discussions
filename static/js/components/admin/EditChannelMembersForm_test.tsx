...
describe("EditChannelMembersForm", () => {
  ...
  afterEach(() => {
    sandbox.restore();
  });[["contributors", R.prop("contributor_name")], ["moderators", R.prop("moderator_name")]].forEach(([pageDescription, usernameGetter]) => {
    describe(pageDescription, () => {
      ...
      }) => shallow(<EditChannelMembersForm members={members} usernameGetter={usernameGetter} channel={channel} validation={{}} form={form} {...props} />);
      ...
      describe("adding a new member", () => {
        ...
        it("enters text into the field", () => {
          ...
          wrapper.find("input[name='email']").simulate("change", { target: { value: "xyz" } });
