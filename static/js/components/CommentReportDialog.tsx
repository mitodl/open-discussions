...
export default function CommentReportDialog(props: Props) {
  ...
  return <Formik onSubmit={async (values, actions) => {
    const {
      reason
    } = values;
    ...
    reason: ""
  }} validate={validateCommentReportForm} validateOnBlur={false} validateOnChange={false}>
      {({
      handleSubmit,
      errors
    }) => <Form>
          <Dialog open={true} hideDialog={hideDialog} onCancel={hideDialog} onAccept={handleSubmit} validateOnClick={true} title="Report Comment" submitText="Yes, Report" id="report-comment-dialog">
            <div className="form">
              <p>
              ...
              <div className="reason row">
                ...
                <Field type="text" name="reason" placeholder="e.g. this is spam, abusive, etc" />
