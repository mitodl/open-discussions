...
@pytest.mark.parametrize('value_in_settings,default,default_in_settings,expected', [
    (None, None, True, True),
...
def test_is_enabled(settings, value_in_settings, default, default_in_settings, expected):
