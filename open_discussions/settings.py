...
ELASTICSEARCH_CONNECTIONS_PER_NODE = get_int("ELASTICSEARCH_CONNECTIONS_PER_NODE", 10)
ELASTICSEARCH_INDEXING_CHUNK_SIZE = get_int("ELASTICSEARCH_INDEXING_CHUNK_SIZE", 100)
ELASTICSEARCH_DOCUMENT_INDEXING_CHUNK_SIZE = get_int(
    "ELASTICSEARCH_DOCUMENT_INDEXING_CHUNK_SIZE",
    get_int("ELASTICSEARCH_INDEXING_CHUNK_SIZE", 100),
)
...
ELASTICSEARCH_MAX_REQUEST_SIZE = get_int("ELASTICSEARCH_MAX_REQUEST_SIZE", 10000000)
