...
def mock_moira(mocker):
    ...
    return mocker.patch("moira.moira_api.Moira")


@pytest.fixture
def mock_moira_client(mocker):
    """Return a fake moira client"""
    return mocker.patch("moira.moira_api.get_moira_client", autospec=True)


@pytest.fixture
def mock_user_moira_lists(mocker):
    """Return a fake moira client"""
    mocked = mocker.patch("moira.moira_api.user_moira_lists")
