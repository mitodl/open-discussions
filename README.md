...
- `OPEN_DISCUSSIONS_HOSTNAME`
    ...
    Sets the hostname for DOCKER_HOST in setup. Should likely be whatever you set the host to in your /etc/hosts or
    where you're accessing it from. Likely `od.odl.local`.
