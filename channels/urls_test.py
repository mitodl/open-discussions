...
def test_urls():
    ...
    assert reverse('subscribe', kwargs={"channel_name": 'a_channel'}) == '/api/v0/channels/a_channel/subscribe/'
    assert reverse('unsubscribe', kwargs={"channel_name": 'a_channel'}) == '/api/v0/channels/a_channel/unsubscribe/'
